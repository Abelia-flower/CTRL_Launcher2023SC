...
Main file   : ./com/beep.s
Current file: ./com/beep.s
...
000000r 1               ; -------------------------------------------------------------------
000000r 1               .BSS
000000r 1  xx             TMP_MIX:          .RES 1
000001r 1  xx             TMP_SHAPE:        .RES 1
000002r 1  xx             TMP_VOL:          .RES 1
000003r 1               
000003r 1               ; -------------------------------------------------------------------
000003r 1               ;                               マクロ
000003r 1               ; -------------------------------------------------------------------
000003r 1               .macro setSound frq,efrq,shape,mix,vol
000003r 1                 ; 音は出さない
000003r 1                 ; ミキシング設定
000003r 1                 LDA #YMZ::IA_MIX
000003r 1                 LDX #%00111111
000003r 1                 JSR SET_YMZREG
000003r 1                 LDA mix
000003r 1                 STA TMP_MIX
000003r 1                 ; 音階上位
000003r 1                 LDA #YMZ::IA_FRQ+1
000003r 1                 LDX #>(125000/frq)
000003r 1                 JSR SET_YMZREG
000003r 1                 ; 音階下位
000003r 1                 LDA #YMZ::IA_FRQ
000003r 1                 LDX #<(125000/frq)
000003r 1                 JSR SET_YMZREG
000003r 1                 ; エンベ上位
000003r 1                 LDA #YMZ::IA_EVLP_FRQ+1
000003r 1                 LDX #>(244000/efrq)
000003r 1                 JSR SET_YMZREG
000003r 1                 ; エンベ下位
000003r 1                 LDA #YMZ::IA_EVLP_FRQ
000003r 1                 LDX #<(244000/efrq)
000003r 1                 JSR SET_YMZREG
000003r 1                 ; 形状
000003r 1                 LDA shape
000003r 1                 STA TMP_SHAPE
000003r 1                 ; 音量
000003r 1                 LDA vol
000003r 1                 STA TMP_VOL
000003r 1               .endmac
000003r 1               ; -------------------------------------------------------------------
000003r 1               ;                             実行領域
000003r 1               ; -------------------------------------------------------------------
...
000000r 1               START:
000000r 1                 ; 音を鳴らす
000000r 1  20 rr rr       JSR POYO
000003r 1                 ; キー待機
000003r 1  A9 02          LDA #BCOS::BHA_CON_RAWIN_WaitAndNoEcho  ; キー入力待機
000005r 1  A2 06 20 03    syscall CON_RAWIN
000009r 1  06           
00000Ar 1  20 rr rr       JSR SILENT
00000Dr 1  60             RTS
00000Er 1               
00000Er 1               SILENT:
00000Er 1  A9 07 A2 3F    setSound 1,1,1,1,0
000012r 1  20 rr rr A5  
000016r 1  01 8D rr rr  
000040r 1  20 rr rr       JSR SOUND
000043r 1  60             RTS
000044r 1               
000044r 1               POYO:
000044r 1  A9 07 A2 3F    setSound 300,700,#$E,#$FE,#$0F
000048r 1  20 rr rr A9  
00004Cr 1  FE 8D rr rr  
000076r 1  20 rr rr       JSR SOUND
000079r 1  60             RTS
00007Ar 1               
00007Ar 1               SOUND:
00007Ar 1  A9 07          LDA #YMZ::IA_MIX
00007Cr 1  AE rr rr       LDX TMP_MIX
00007Fr 1  20 rr rr       JSR SET_YMZREG
000082r 1  A9 0D          LDA #YMZ::IA_EVLP_SHAPE
000084r 1  AE rr rr       LDX TMP_SHAPE
000087r 1  20 rr rr       JSR SET_YMZREG
00008Ar 1  A9 08          LDA #YMZ::IA_VOL
00008Cr 1  AE rr rr       LDX TMP_VOL
00008Fr 1  20 rr rr       JSR SET_YMZREG
000092r 1  60             RTS
000093r 1               
000093r 1               ; *
000093r 1               ; --- 内部レジスタに値を格納する ---
000093r 1               ; データをA、内部アドレスをXに格納しておくこと
000093r 1               ; この通り呼ぶ意味はあまりない
000093r 1               ; *
000093r 1               SET_YMZREG:
000093r 1  8D 00 E4       STA YMZ::ADDR
000096r 1  8E 01 E4       STX YMZ::DATA
000099r 1  60             RTS
00009Ar 1               
00009Ar 1               
