...
Main file   : ./com/test/t-ir-vbk.s
Current file: ./com/test/t-ir-vbk.s

000000r 1               ; -------------------------------------------------------------------
000000r 1               ; VBLKTESTコマンド
000000r 1               ; -------------------------------------------------------------------
000000r 1               ; 垂直同期割り込みをコマンドルーチンにもお届け
000000r 1               ; -------------------------------------------------------------------
...
000000r 1               ; -------------------------------------------------------------------
000000r 1               .BSS
000000r 1  xx xx        VB_STUB:          .RES 2  ; 割り込み終了処理
000002r 1  xx           COUNTER:          .RES 1  ; カウンタ
000003r 1               
000003r 1               ; -------------------------------------------------------------------
000003r 1               ;                             実行領域
000003r 1               ; -------------------------------------------------------------------
000003r 1               .CODE
000000r 1               START:
000000r 1                 ;割り込みハンドラの登録
000000r 1  78             SEI
000001r 1  A9 rr A0 rr    loadAY16 VBLANK
000005r 1  A2 26 20 03    syscall IRQ_SETHNDR_VB
000009r 1  06           
00000Ar 1  8D rr rr 8C    storeAY16 VB_STUB
00000Er 1  rr rr        
000010r 1  58             CLI
000011r 1               LOOP:
000011r 1  AD rr rr       LDA COUNTER
000014r 1  D0 FB          BNE LOOP                ; 非ゼロならスキップ
000016r 1                 ; カウンタがゼロ
000016r 1  A9 21          LDA #'!'
000018r 1  A2 04 20 03    syscall CON_OUT_CHR
00001Cr 1  06           
00001Dr 1  A9 3C          LDA #60
00001Fr 1  8D rr rr       STA COUNTER
000022r 1  80 ED          BRA LOOP
000024r 1  60             RTS
000025r 1               
000025r 1               ; 垂直同期割り込み処理
000025r 1               VBLANK:
000025r 1  AD rr rr       LDA COUNTER
000028r 1  F0 03          BEQ @EXT                ; ゼロならスルー
00002Ar 1                 ; カウンタがゼロでない
00002Ar 1  CE rr rr       DEC COUNTER
00002Dr 1               @EXT:
00002Dr 1  6C rr rr       JMP (VB_STUB)           ; 片付けはBCOSにやらせる
000030r 1               
000030r 1               
