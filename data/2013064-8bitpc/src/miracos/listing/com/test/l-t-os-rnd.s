...
Main file   : ./com/test/t-os-rnd.s
Current file: ./com/test/t-os-rnd.s
...
000000r 1               ; -------------------------------------------------------------------
000000r 1               .ZEROPAGE
000000r 1  xx xx        ZP_RND_ADDR16:         .RES 2
000002r 1               
000002r 1               ; -------------------------------------------------------------------
000002r 1               ;                             実行領域
000002r 1               ; -------------------------------------------------------------------
...
00000Br 1               LOOP:
00000Br 1  A9 02          LDA #$2                   ; エコーなし入力
00000Dr 1  A2 06 20 03    syscall CON_RAWIN
000011r 1  06           
000012r 1  20 rr rr       JSR GET_RND_D
000015r 1  20 rr rr       JSR PRT_NUM
000018r 1  20 rr rr       JSR PRT_S
00001Br 1  80 EE          BRA LOOP
00001Dr 1               
00001Dr 1               ; -------------------------------------------------------------------
00001Dr 1               ;                           10進1桁乱数取得
00001Dr 1               ; -------------------------------------------------------------------
00001Dr 1               GET_RND_D:
00001Dr 1               X5PLUS1RETRY:
00001Dr 1  B2 rr          LDA (ZP_RND_ADDR16)
00001Fr 1  0A             ASL
000020r 1  0A             ASL
000021r 1  38             SEC ;+1
000022r 1  72 rr          ADC (ZP_RND_ADDR16)
000024r 1  92 rr          STA (ZP_RND_ADDR16)
000026r 1  29 0F          AND #$0F
000028r 1  C9 0F          CMP #$0F
00002Ar 1  F0 F1          BEQ X5PLUS1RETRY    ;ハイ次！
00002Cr 1  C9 0A          CMP #$0A
00002Er 1  30 11          BMI SKIP_DECIMALIZE ;Aが比較する値よりも小さい場合はNが立ち
000030r 1  0A             ASL
000031r 1  48             PHA
000032r 1  B2 rr          LDA (ZP_RND_ADDR16)
000034r 1  0A             ASL
000035r 1  92 rr          STA (ZP_RND_ADDR16)
000037r 1  68             PLA
000038r 1  E9 13          SBC #$13            ;深遠なる理由で$13of$14を引くとよい
00003Ar 1  48             PHA
00003Br 1  B2 rr          LDA (ZP_RND_ADDR16)
00003Dr 1  6A             ROR
00003Er 1  92 rr          STA (ZP_RND_ADDR16)
000040r 1  68             PLA
000041r 1               SKIP_DECIMALIZE:
...
000046r 1  09 30          ORA #$30
000048r 1               PRT_CHR:
000048r 1  A2 04 20 03    syscall CON_OUT_CHR
00004Cr 1  06           
00004Dr 1  60             RTS
00004Er 1               
00004Er 1               ; -------------------------------------------------------------------
