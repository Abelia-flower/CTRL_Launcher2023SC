...
Main file   : ./com/color.s
Current file: ./com/color.s

000000r 1               ; -------------------------------------------------------------------
000000r 1               ;                           COLORコマンド
000000r 1               ; -------------------------------------------------------------------
000000r 1               ; GCHRの色を変更する
000000r 1               ; -------------------------------------------------------------------
...
000000r 1               .CODE
000000r 1               START:
000000r 1  A9 rr A0 rr    loadAY16 STR_COLOR_START
000004r 1  A2 08 20 03    syscall CON_OUT_STR                 ; 説明文
000008r 1  06           
000009r 1               @LOOP:
000009r 1  A9 02          LDA #2
00000Br 1  A2 06 20 03    syscall CON_RAWIN                   ; コマンド入力
00000Fr 1  06           
000010r 1               @J:
000010r 1  C9 6A          CMP #'j'
000012r 1  D0 0D          BNE @K
000014r 1  A9 00          LDA #0
000016r 1  20 rr rr       JSR @GET
000019r 1  88             DEY
00001Ar 1  A9 02          LDA #2
00001Cr 1  20 rr rr       JSR @PUT
00001Fr 1  80 E8          BRA @LOOP
000021r 1               @K:
000021r 1  C9 6B          CMP #'k'
000023r 1  D0 0D          BNE @H
000025r 1  A9 00          LDA #0
000027r 1  20 rr rr       JSR @GET
00002Ar 1  C8             INY
00002Br 1  A9 02          LDA #2
00002Dr 1  20 rr rr       JSR @PUT
000030r 1  80 D7          BRA @LOOP
000032r 1               @H:
000032r 1  C9 68          CMP #'h'
000034r 1  D0 0D          BNE @L
000036r 1  A9 01          LDA #1
000038r 1  20 rr rr       JSR @GET
00003Br 1  88             DEY
00003Cr 1  A9 03          LDA #3
00003Er 1  20 rr rr       JSR @PUT
000041r 1  80 C6          BRA @LOOP
000043r 1               @L:
000043r 1  C9 6C          CMP #'l'
000045r 1  D0 0B          BNE @ENT
000047r 1  A9 01          LDA #1
000049r 1  20 rr rr       JSR @GET
00004Cr 1  C8             INY
00004Dr 1  A9 03          LDA #3
00004Fr 1  20 rr rr       JSR @PUT
000052r 1               @ENT:
000052r 1  C9 0A          CMP #$A
000054r 1  D0 B3          BNE @LOOP
000056r 1                 ;JSR PRT_LF
000056r 1  A9 0A          LDA #$A
000058r 1  A2 04 20 03    syscall CON_OUT_CHR
00005Cr 1  06           
00005Dr 1  60             RTS
00005Er 1               @GET:
00005Er 1  A2 10 20 03    syscall GCHR_COL
000062r 1  06           
000063r 1  A8             TAY
000064r 1  60             RTS
000065r 1               @PUT:
000065r 1  A2 10 20 03    syscall GCHR_COL
000069r 1  06           
00006Ar 1  60             RTS
00006Br 1               
00006Br 1  43 6F 6E 73  STR_COLOR_START:  .BYT "Console Color Setting.",$A,"j,k  : Character",$A,"h,l  : Background",$A,"ENTER: Complete",$0
00006Fr 1  6F 6C 65 20  
000073r 1  43 6F 6C 6F  
0000B5r 1               
0000B5r 1               
