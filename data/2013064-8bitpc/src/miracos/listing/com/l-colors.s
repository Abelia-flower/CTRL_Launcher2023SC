...
Main file   : ./com/colors.s
Current file: ./com/colors.s

000000r 1               ; -------------------------------------------------------------------
000000r 1               ;                            COLORS.COM
000000r 1               ; -------------------------------------------------------------------
000000r 1               ; 色一覧
000000r 1               ; -------------------------------------------------------------------
...
000000r 1               ;                               定数
000000r 1               ; -------------------------------------------------------------------
000000r 1               BOX_WIDTH   = (256/2)/4
000000r 1               BOX_HEIGHT  = 192/4
000000r 1               
000000r 1               ; -------------------------------------------------------------------
000000r 1               ;                               ZP領域
000000r 1               ; -------------------------------------------------------------------
000000r 1               .ZEROPAGE
000000r 1  xx             ZP_COLOR:                 .RES 1
000001r 1  xx             ZP_CANVAS_Y:              .RES 1
000002r 1  xx             ZP_X:                     .RES 1
000003r 1  xx             ZP_Y:                     .RES 1
000004r 1  xx             ZP_CNT_X:                 .RES 1
000005r 1  xx             ZP_CNT_Y:                 .RES 1
000006r 1               
000006r 1               ; -------------------------------------------------------------------
000006r 1               ;                             実行領域
000006r 1               ; -------------------------------------------------------------------
...
000000r 1                 ; ---------------------------------------------------------------
000000r 1                 ;   CRTC
000000r 1  A9 01          LDA #%00000001            ; 全フレーム16色モード、16色モード座標書き込み、書き込みカウントアップ有効
000002r 1  8D 01 E6       STA CRTC::CFG
000005r 1  A9 55          LDA #%01010101            ; フレームバッファ1
000007r 1  8D 05 E6       STA CRTC::RF              ; FB1を表示
00000Ar 1  8D 06 E6       STA CRTC::WF              ; FB1を書き込み先に
00000Dr 1                 ; ---------------------------------------------------------------
00000Dr 1                 ;   画面の初期化
00000Dr 1  A9 00          LDA #$00
00000Fr 1  20 rr rr       JSR FILL
000012r 1                 ; ---------------------------------------------------------------
000012r 1                 ;   描画
000012r 1  64 rr          STZ ZP_COLOR
000014r 1  64 rr          STZ ZP_X
000016r 1  64 rr          STZ ZP_Y
000018r 1  A9 04          LDA #4
00001Ar 1  85 rr          STA ZP_CNT_X
00001Cr 1  85 rr          STA ZP_CNT_Y
00001Er 1               LOOP:
00001Er 1  A6 rr          LDX ZP_X
000020r 1  A4 rr          LDY ZP_Y
000022r 1  A5 rr          LDA ZP_COLOR
000024r 1  20 rr rr       JSR DRAW_BOX
000027r 1                 ; 位置を進める
000027r 1  A9 20          LDA #BOX_WIDTH
000029r 1  18             CLC
00002Ar 1  65 rr          ADC ZP_X
00002Cr 1  85 rr          STA ZP_X
00002Er 1  C6 rr          DEC ZP_CNT_X
000030r 1  D0 0F          BNE @SKP_INC_Y
000032r 1                 ; Y進め
000032r 1  A9 04          LDA #4
000034r 1  85 rr          STA ZP_CNT_X
000036r 1  A9 30          LDA #BOX_HEIGHT
000038r 1  18             CLC
000039r 1  65 rr          ADC ZP_Y
00003Br 1  85 rr          STA ZP_Y
00003Dr 1  C6 rr          DEC ZP_CNT_Y
00003Fr 1  F0 09          BEQ END
000041r 1               @SKP_INC_Y:
000041r 1                 ;; ---------------------------------------------------------------
000041r 1                 ;;   キー入力待機
000041r 1                 ;LDA #BCOS::BHA_CON_RAWIN_WaitAndNoEcho
000041r 1                 ;syscall CON_RAWIN
000041r 1                 ; 色を進める
000041r 1  A9 11          LDA #$11
000043r 1  18             CLC
000044r 1  65 rr          ADC ZP_COLOR
000046r 1  85 rr          STA ZP_COLOR
000048r 1                 ;CMP #$FF
000048r 1  80 D4          BRA LOOP
00004Ar 1               END:
00004Ar 1                 ; ---------------------------------------------------------------
00004Ar 1                 ;   キー入力待機
00004Ar 1  A9 02          LDA #BCOS::BHA_CON_RAWIN_WaitAndNoEcho
00004Cr 1  A2 06 20 03    syscall CON_RAWIN
000050r 1  06           
000051r 1  60             RTS
000052r 1               
000052r 1               ; 指定色で正方形領域を塗りつぶす
000052r 1               ; X,Yがそのまま座標
000052r 1               DRAW_BOX:
000052r 1  48             PHA
000053r 1  98             TYA
000054r 1  18             CLC
000055r 1  69 30          ADC #BOX_HEIGHT
000057r 1  85 rr          STA ZP_CANVAS_Y
000059r 1  68             PLA
00005Ar 1               DRAW_SQ_LOOP:
00005Ar 1  8E 02 E6       STX CRTC::VMAH
00005Dr 1  8C 03 E6       STY CRTC::VMAV
000060r 1  8D 04 E6 8D    .REPEAT BOX_WIDTH
000064r 1  04 E6 8D 04  
000068r 1  E6 8D 04 E6  
0000C0r 1                 STA CRTC::WDBF
0000C0r 1                 .ENDREPEAT
0000C0r 1  C8             INY
0000C1r 1  C4 rr          CPY ZP_CANVAS_Y
0000C3r 1  D0 95          BNE DRAW_SQ_LOOP
0000C5r 1  60             RTS
0000C6r 1               
0000C6r 1               ; 画面全体をAの値で埋め尽くす
0000C6r 1               FILL:
0000C6r 1  A0 00          LDY #$00
0000C8r 1  8C 03 E6       STY CRTC::VMAV
0000CBr 1  8C 02 E6       STY CRTC::VMAH
0000CEr 1  A0 C0          LDY #$C0
0000D0r 1               FILL_LOOP_V:
0000D0r 1  A2 80          LDX #$80
0000D2r 1               FILL_LOOP_H:
0000D2r 1  8D 04 E6       STA CRTC::WDBF
0000D5r 1  CA             DEX
0000D6r 1  D0 FA          BNE FILL_LOOP_H
0000D8r 1  88             DEY
0000D9r 1  D0 F5          BNE FILL_LOOP_V
0000DBr 1  60             RTS
0000DCr 1               
0000DCr 1               
