...
namespace THE_Tournament
{
    class Setting : Scene
    {
        protected override void makehelps(List<message> help)
        {
            ...
            help.AddRange(message.hutidorin(si / 15
                , hyo.camx + hyo.ww * 0.01f, hyo.camy + hyo.wh * 0.8f, si, 999, 0, 0, -1,
                getHelpstring("setting")
                , 0, 0, 0, false, kazu: 4));
        }
        ...
        public Setting(SceneManager s, Scene next) : base(s)
        {
            ...
            float w = hyo.ww * 0.5f;
            {
                ...
                sss.add();
                sss.setcxy(hyo.ww * 0.02f,hyo.ww*0.02f,0,0);
                exit = sss;
    ...
    class KeyConfig : Scene
    {
        protected override void makehelps(List<message> help)
        {
            ...
            help.AddRange(message.hutidorin(si / 15
                , hyo.camx + hyo.ww * 0.01f, hyo.camy + hyo.wh * 0.8f, si, 9999, 0, 0, -1,
                getHelpstring("keyconfig")
                , 0, 0, 0, false, kazu: 4));
        }
        character inami; serif serif;
        float inati = 0;
